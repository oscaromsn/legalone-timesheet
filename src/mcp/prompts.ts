...
export const prompts: Prompt[] = [
  ...
  },
  {
    ...
    body: () => [
      ...
      '',
      'Finish by telling them the configuration is in force but marked provisional, so booking hours is still',
      'refused, and that proving it means running `bun run setup --write` once in a terminal — it files one probe',
      'entry, reads it back field by field and deletes it. Reading, searching and planning work meanwhile.',
    ].join('\n'),
  },
  {
    name: 'analisar-horas',
