...
export const prompts: Prompt[] = [
  ...
  },
  {
    ...
    body: () => [
      ...
      '    they gave you. If the answer is a person rather than a case — "lança no contato do Y, não abre pasta"',
      '    — give "contato: <name>" as the value and it binds to that contact. It is not `overrides`, which',
      '    settles only the six firm defaults and now refuses any',
